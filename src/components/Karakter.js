  ...
  return (
    <Accordion className="accordion-item">
      ...
      <AccordionDetails>
        <Typography>
          <p>
            <strong>gender:</strong> {kisi.gender}
          </p>
          <p>
            <strong>hair color:</strong> {kisi.hair_color}
          </p>
          <p>
            <strong>height:</strong> {kisi.height}
          </p>
          <p>
            <strong>homeworld:</strong> {gezegen}
          </p>
          <p>
            <strong>mass: </strong>
            {kisi.mass}
          ...
          <p>
            <strong>skin color:</strong> {kisi.skin_color}
          </p>
          <p>
